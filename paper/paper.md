...
Bioschemas is a community effort `[@citesAsDataSource:Gray2023]` to improve the FAIRness of web-based resources. Established by ELIXIR over seven years ago, it has good adoption by the technical communities in workflows, software, and tools `[@citesAsDataSource:Castro2023; @citesAsDataSource:@citesAsDataSource:Rosinach2023; @citesAsDataSource:Arend2024; @citesAsDataSource:Soiland-Reyes2024]` but less adoption than it should be. Particularly in less technical communities such as training or even data services.
